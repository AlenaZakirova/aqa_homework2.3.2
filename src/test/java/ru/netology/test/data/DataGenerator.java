...
public class DataGenerator {
    ...
    public static String generateCity() {
        var cities = new String[]{"Благовененск", "Архангельск", "Астрахань",
                ...
                "Севастополь", "Биробиджан", "Нарьян-Мар", "Ханты-Мансийск", "Анадырь", "Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Магас", "Нальчик",
                ...
                "Влапивосток", "Ставрополь", "Хабаровск"};
        return cities[new Random().nextInt(83)];
    }
